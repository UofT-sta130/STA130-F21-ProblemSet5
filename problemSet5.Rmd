...
It is actually very hard to get a census of a whole town (why many countries only run their census every 10 years and why they cost so much!), so let's suppose we only have the sample of 1000 (`orig_sample`). That is still a pretty big random sample!
